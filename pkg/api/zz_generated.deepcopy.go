...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeRealUtilizationThresholds) DeepCopyInto(out *NodeRealUtilizationThresholds) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeRealUtilizationThresholds.
func (in *NodeRealUtilizationThresholds) DeepCopy() *NodeRealUtilizationThresholds {
	if in == nil {
		return nil
	}
	out := new(NodeRealUtilizationThresholds)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StrategyParameters) DeepCopyInto(out *StrategyParameters) {
	*out = *in
	...
	if in.NodeRealUtilizationThresholds != nil {
		in, out := &in.NodeRealUtilizationThresholds, &out.NodeRealUtilizationThresholds
		*out = new(NodeRealUtilizationThresholds)
		**out = **in
	}
