...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeRealUtilizationThresholds)(nil), (*api.NodeRealUtilizationThresholds)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NodeRealUtilizationThresholds_To_api_NodeRealUtilizationThresholds(a.(*NodeRealUtilizationThresholds), b.(*api.NodeRealUtilizationThresholds), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.NodeRealUtilizationThresholds)(nil), (*NodeRealUtilizationThresholds)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_NodeRealUtilizationThresholds_To_v1alpha1_NodeRealUtilizationThresholds(a.(*api.NodeRealUtilizationThresholds), b.(*NodeRealUtilizationThresholds), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_NodeRealUtilizationThresholds_To_api_NodeRealUtilizationThresholds(in *NodeRealUtilizationThresholds, out *api.NodeRealUtilizationThresholds, s conversion.Scope) error {
	out.WatcherAddress = in.WatcherAddress
	out.TargetCpuRate = in.TargetCpuRate
	out.TargetMemoryRate = in.TargetMemoryRate
	return nil
}

// Convert_v1alpha1_NodeRealUtilizationThresholds_To_api_NodeRealUtilizationThresholds is an autogenerated conversion function.
func Convert_v1alpha1_NodeRealUtilizationThresholds_To_api_NodeRealUtilizationThresholds(in *NodeRealUtilizationThresholds, out *api.NodeRealUtilizationThresholds, s conversion.Scope) error {
	return autoConvert_v1alpha1_NodeRealUtilizationThresholds_To_api_NodeRealUtilizationThresholds(in, out, s)
}

func autoConvert_api_NodeRealUtilizationThresholds_To_v1alpha1_NodeRealUtilizationThresholds(in *api.NodeRealUtilizationThresholds, out *NodeRealUtilizationThresholds, s conversion.Scope) error {
	out.WatcherAddress = in.WatcherAddress
	out.TargetCpuRate = in.TargetCpuRate
	out.TargetMemoryRate = in.TargetMemoryRate
	return nil
...
// Convert_api_NodeRealUtilizationThresholds_To_v1alpha1_NodeRealUtilizationThresholds is an autogenerated conversion function.
func Convert_api_NodeRealUtilizationThresholds_To_v1alpha1_NodeRealUtilizationThresholds(in *api.NodeRealUtilizationThresholds, out *NodeRealUtilizationThresholds, s conversion.Scope) error {
	return autoConvert_api_NodeRealUtilizationThresholds_To_v1alpha1_NodeRealUtilizationThresholds(in, out, s)
}
...
func autoConvert_v1alpha1_StrategyParameters_To_api_StrategyParameters(in *StrategyParameters, out *api.StrategyParameters, s conversion.Scope) error {
	...
	out.NodeRealUtilizationThresholds = (*api.NodeRealUtilizationThresholds)(unsafe.Pointer(in.NodeRealUtilizationThresholds))
...
func autoConvert_api_StrategyParameters_To_v1alpha1_StrategyParameters(in *api.StrategyParameters, out *StrategyParameters, s conversion.Scope) error {
	...
	out.NodeRealUtilizationThresholds = (*NodeRealUtilizationThresholds)(unsafe.Pointer(in.NodeRealUtilizationThresholds))
	out.NodeAffinityType = *(*[]string)(unsafe.Pointer(&in.NodeAffinityType))
